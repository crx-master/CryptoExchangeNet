...
namespace CryptoExchangeNet
{
    ...
    public abstract class BaseClient : IDisposable
    {
        ...
        protected BaseClient(string name, BaseClientOptions options)
        {
            ...
            log.Write(LogLevel.Trace, $"Client configuration: {options}, CryptoExchangeNet: v{typeof(BaseClient).Assembly.GetName().Version}, {name}.Net: v{GetType().Assembly.GetName().Version}");
        }
